/**
 * Mensagens e textos de validação
 */
export const MESSAGES = {
  ...
  PRICE_FOUND: '💰 Preço encontrado:',
  ADD_TO_CART_BUTTON_FOUND: '✅ Botão de adicionar à sacola encontrado',
  PRODUCT_PAGE_LOADED: '✅ Página do produto carregada com sucesso!',
  ...
  // Resumo
  SUMMARY: '📊 Resumo:',
  PRODUCT_IDENTIFIED: '   - Produto identificado:',
  URL: '   - URL:',
